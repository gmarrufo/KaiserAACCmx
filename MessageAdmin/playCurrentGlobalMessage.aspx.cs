...
namespace KaiserAACCmx.MessageAdmin
{
	...
	/// 9955
	/// </summary>
	public partial class playCurrentGlobalMessage : XMLPage
	{
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{				
				...
				Prompt p = new Prompt();
				p.TimeOut = 0;
				p.addVoiceFileToPrompt(ConfigurationSettings.AppSettings["voxURL"] + Request.QueryString["lang"].ToString().Trim() + "/dynamicGlobalMessage.vox", true,"The dynamic global message is not active");
				p.BargeIn = false;
				ply.setPrompt(p);
